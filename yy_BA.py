...
def _argparse():
    ...
    parser.add_argument('--color', type=str, default='crimson', choices=['crimson', 'darkblue', 'darkgreen', 'goldenrod'], help='Color for both figures')
    parser.add_argument('--markersize', type=int, default=1, help='Dots size for both figures')
    parser.add_argument('--ci', type=int, default=None, help='Make CI or not for yy figure.')
    parser.add_argument('--boot', type=int, default=1000, help='Boot times.')
    parser.add_argument('--randomline', default=False, help='Draw randomline or not.')
    ...
    parser.add_argument('--max_in_diff', default=False, type=float, help='Set maximam value in the BA figure')
